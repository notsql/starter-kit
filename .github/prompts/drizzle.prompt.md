For all Drizzle related queries, do the following:
...
3. If the query is not found in the documentation, answer based on your knowledge of Drizzle and inform the user that the information is not available in the documentation

## Drizzle Documentation for LLMs
...
- [Drizzle \<\> PostgreSQL](https://orm.drizzle.team/docs/get-started-gel)
